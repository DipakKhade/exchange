...
export default function Header(){
 ...
 <div className="flex h-14 w-full flex-col justify-center pl-[21px] pr-4">
        ...
        <li className={`ml-[20px] text-xl mr-[20px] flex flex-row items-center justify-center ${path==='/' ? 'text-white' : 'text-slate-500'}`}

onClick={()=>router.push('/')}>exchange</li>
            ...
            <li className={`ml-[20px] mr-[20px] flex flex-row items-center justify-center ${slugPath===actualPath ? 'text-white' : 'text-slate-500'} `} onClick={()=>router.push('/trade/SOL_USDC')}>Treads</li>
